            ...
            if (entity != null) {
                if(!entity.getMainHandItem().isEmpty()){
                    if(entity.experienceLevel>=exp){
                        ...
                        entity.sendMessage(Component.nullToEmpty(I18n.get("commands.iis.cannot_xp").replace("{x}",String.valueOf(exp))),entity.getUUID());
                    }
                }
                    ...
                    entity.sendMessage(new TranslatableComponent("commands.iis.empty"),entity.getUUID());
                }
            }
            return 0;
        }));
